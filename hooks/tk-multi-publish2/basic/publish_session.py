...
class SubstancePainterSessionPublishPlugin(HookBaseClass):
    ...
    def description(self):
        ...
        the published file via the <b><a href='{loader_url}'>Loader</a></b> so long as
        ...
        The <code>version</code> field of the resulting <b>Publish</b> in ShotGrid
    ...
    def accept(self, settings, item):
        ...
        self.logger.info(
            f"Substance Painter '{self.name}' plugin accepted the current session."
        )
    ...
    def validate(self, settings, item):
        ...
        if not path:
            ...
            # validation fails.
            error_msg = "The Substance Painter project has not been saved."
            ...
            if not work_template.validate(path):
                self.logger.warning(
                    ...
                    extra={
                        "action_button": {
                            "label": "Save File",
                            "tooltip": "Save the current Substance Painter project to a "
                            "different file name",
        ...
        if next_version_path and os.path.exists(next_version_path):
            ...
            self.logger.error(
                ...
                extra={
                    "action_button": {
                        "label": f"Save to v{version}",
                        "tooltip": f"Save to the next available version number, v{version}",
...
def _substancepainter_find_additional_session_dependencies():
    ...
    """
    # NOT IMPLEMENTED, perhaps could include a reference to the published mesh
...
def _save_session(path):
    ...
    sp.project.save_as(path, sp.project.ProjectSaveMode.Full)
